            ...
            <van-grid-item v-for="item in list" :key="item">
              ...
              <div class="orderItem">
                <div class="useStatus">
                  <span
                    >{{ item.venueName }}
                    <van-tag type="primary" size="large">物业费</van-tag>
                  </span>
                  <span>{{
                ...
                <div class="orderInfo">
                  ...
                  <p>缴费单位 : {{ item.payer }}</p>
                  <p>缴费明细 : {{ item.expenseType }}</p>
                  <p>缴纳金额 : ￥{{ item.totalPrice }}</p>
...
export default {
  ...
  data() {
    return {
      list: [
        {
          transDate: '2022-07-07',
          transTime: '12:00:00',
          billNo: '123456789',
          payer: '广州天河区某某物业公司',
          expenseType: '2022年物业管理费',
          totalPrice: '500.00',
        },
        {
          transDate: '2022-07-07',
